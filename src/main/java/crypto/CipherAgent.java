...
public interface CipherAgent {
	...
	public String decrypt(byte[] encryptedBytes, byte[] iv, SecretKey key) throws UnsupportedEncodingException, IOException, InvalidKeyException, InvalidAlgorithmParameterException;
}
